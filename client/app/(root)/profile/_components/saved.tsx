...
import { useSavedBlogs } from "@/hooks/queries/use-blogs"

export default function Saved() {
  const { data: blogs, isLoading, isError, error, refetch } = useSavedBlogs()
  ...
  return (
    <div className="mt-8 mb-12 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      {!isLoading &&
        !isError &&
