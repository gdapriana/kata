...
import type {
  CommentCreateResponseType,
  CommentGetAllResponseType,
...
export class CommentController {
  static GetAll = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      } = await CommentService.GetAll(req.query as any);
  ...
  static Create = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const result: CommentCreateResponseType = await CommentService.Create({
        userId,
        ...req.body,
      });
