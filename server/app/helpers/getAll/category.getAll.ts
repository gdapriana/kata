...
import { CategoryValidation, type CategoryValidationGetAll } from "../../validation/category.validation.js";
import { Validation } from "../../validation/validation.js";
import { type CategoryGetAllResponseType, CategoryResponse } from "../responses/category.response.js";
import type { Pagination } from "../types/pagination.type.js";
import { Prisma } from "../../generated/prisma/client.js";

export const categoryGetAll = (data: CategoryValidationGetAll): Promise<{ query: CategoryGetAllResponseType[]; pagination: Pagination }> => {
